...
public class MessageConfiguration {
    private String exchangeName="pizzaexchange";
    private String registerQueue="pizzaqueue";
    @Bean
    ...
    {
        return BindingBuilder.bind(registerQueue()).to(exchange).with("pizzaroutingkey");
    }
}
